...
\begin{itemize}
  \item Safety. Nuclear engineers are ethically responsible for designing reactors that will not harm the public. This boils down to two requirements
  \begin{itemize}
    \item Contain the fission products
    \item Cool the reactor
  \end{itemize}
