...
% We need to add the columns: Ductility R\&D needs, (max burn up)
% We ought to do the transpose of this table...
\begin{center}
...
The low operating pressures of liquid coolants provide the additional benefit of precluding control rod ejection accidents (but not accidental withdrawal). 
...
Lead coolant will be able to eliminate the secondary loop required for sodium reactors. 
Sodium reactors may also be able to cut out that circuit if carbon dioxide is used as the working fluid.


% \FloatBarrier %needs graphicx, I think
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%also makes Doppler coefficient more positive?
