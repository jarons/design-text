...
% We need to add the columns: swelling
\begin{center}
\begin{tabular}[c]{| p{1.6cm} | p{1.2cm} | p{2.05cm} | p{1.5cm} | p{1.5cm} | p{1.5cm} | p{1.5cm} | p{1.5cm} | p{2cm} |}
\hline
\multicolumn{8}{|c|}{Potential Fuel Materials Grading Matrix} \\
\hline
 & Physical Density \{g/cm$^3$\} & Fission Material Density \{g/cm$^3$\} & Thermal Conductivity  \{W/(m-K)\} & Melting Point \{K\} & Reactivity & Chemical Compatibility & Ductility & Linear Expansion Coefficient \{10$^6$(1/K)\} \\
\hline
Uranium dioxide (UO$_2$) & \{10.963\} & \{9.664\} & 5 \{2.6\} (1523 K, theor. density) & 1 \{3120\} & & 1 & & \{9.8\} (300 K)  \\
\hline
Uranium carbide (UC) & \{13.630\} & \{12.970\} & \{23.0\} (700 K) & \{2793\} & & & & \{10.5\} (300 K)\\
\hline
Uranium nitride (UN) & \{14.420\} & \{13.619\} & \{20.9\} (1000 K) & 1 \{3123\} & & & & \{7.5\} (300 K) \\
\hline
%Uranium zirconium (UZr) alloys & \\
U-20\%Pu-10\%Zr & & \{14.1\} & \{16\} & \{1400\} &  &  & & \{17\}\\
%http://www.sciencedirect.com/science/article/pii/S1738573315000753
\hline
Uranium silicide (U$_3$Si$_2$)  & \{12.2\} & \{11.3\} & \{22\} (1000 K) & \{1938\} & & & & \{16.1\}\\
\hline
