...
% openany option allows chapters to start on either left or right side of a page. This eliminates a blank page that we had been seeing.
...
\usepackage{setspace} %used for a table in Chapter 3
\usepackage{placeins} % Chapter 4, allows \FloatBarrier

% These two lines eliminate the extra page break before bibliographies
\usepackage{etoolbox}
...
% \let\clearpage\relax  %this command gets rid of page breaks between sections
\include{content1}
